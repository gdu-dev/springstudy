...
public class MyFileUtil {
  ...
  public String getPath() {
    ...
    return "/storage/" + now.getYear() + "/" + String.format("%02d", now.getMonthValue()) + "/" + String.format("%02d", now.getDayOfMonth());
  }
  ...
  public String getYesterdayPath() {
    ...
    return "/storage" + "/" + date.getYear() + "/" + String.format("%02d", date.getMonthValue()) + "/" + String.format("%02d", date.getDayOfMonth());
  }
